...
window.addEventListener("DOMContentLoaded", function (event) {
  ...
  toolbarButton.addEventListener("click", function () {
    ...
    if (toolbarOpen) {
      ...
      backpackInterval = window.setInterval(function () {
  ...
  downloadImgBtn.addEventListener("click", function () {
    Object(_screen_capture__WEBPACK_IMPORTED_MODULE_1__["takeSnapshot"])();
  }); //-----------------------------------------------------------
  ...
  mouseCanvas.addEventListener("mousemove", function (e) {
    mouseCtx.clearRect(0, 0, mouseCanvas.width, mouseCanvas.height);
    mouseCoord = _util_js__WEBPACK_IMPORTED_MODULE_0__["getPosition"](e, mouseCanvas);
    mouseCtx.beginPath();
    mouseCtx.arc(mouseCoord.x, mouseCoord.y, spraySize + 8, 0, 2 * Math.PI);
    mouseCtx.stroke();
    mouseCtx.fill();
...
function takeSnapshot() {
  ...
  html2canvas__WEBPACK_IMPORTED_MODULE_0___default()(canvasContainer).then(function (canvas) {
